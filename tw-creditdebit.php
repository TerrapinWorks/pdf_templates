...
<div class="row">
    <div class="col col-1-3">
        <div class="inner" height="40mm">
            <div><h3 class="section1_header">Billed To</h3></div><div class="bottompadding">{Customer Name (CreditDebit) (First):99.3} {Customer Name (CreditDebit) (Last):99.6}</div><h3 class="section1_header">Payment Method</h3><div>{How is the customer paying?:2}</div><div style="font-size: 10px;"></div>
        </div>
    </div>
    ...
    <div class="col col-1-3">
        <div class="inner" height="40mm">
           <div><h3 class="section1_header">Invoice Total</h3></div><div class="bottompadding_2"><h1>{Grand Total (Credit / Debit):10}</h1></div><div><h3 class="section1_header">Payment Status</h3></div><div>{Payment Status:44}</div>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col col-1-3">
        <div class="inner-section2" height="40mm">
           <div><h3 class="section2_header">Subtotal <span style="color: #000000;">{What is the subtotal (excluding tax, if applicable)?:3}</span></h3></div><div><h3 class="section2_header">Tax <span style="color: #000000;">{Tax (Credit / Debit):49}</span></h3></div><div class="bottompadding_2"></div><div><h2 class="section2_header">Grand Total <span style="color: #000000;">{Grand Total (Credit / Debit):10}</span></h2></div><h3 class="section2_header">Balance Due <span style="color: #000000;">
           
           [gravityforms action="conditional" merge_tag="{Payment Status:44}" condition="is" value="Pending Charge"]
           {Grand Total (Credit / Debit):10}
           [/gravityforms]
