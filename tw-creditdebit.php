...
<div class="row">
    <div class="col col-1-3">
        <div class="inner" height="40mm">
            <div><h3 class="section1_header">Billed To</h3></div><div class="bottompadding">{Customer Name (CreditDebit) (First):98.3} {Customer Name (CreditDebit) (Last):98.6}</div><h3 class="section1_header">Payment Method</h3><div>{How is the customer paying?:2}</div><div style="font-size: 10px;"></div>
        </div>
    </div>
