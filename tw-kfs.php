    ...
    <table class="header">
    	<tr>
    		...
    		<td width="32%" style="text-align: center;">
                <img width="250px" src='
                    [gravityforms action="conditional" merge_tag="{Which lab are you in?:1}" condition="is" value="Rapid Prototyping Center"]https://s3.amazonaws.com/cdn.terrapin.works/brand/terrapin-works-logo_final_red-black_RPC.png[/gravityforms]
                    [gravityforms action="conditional" merge_tag="{Which lab are you in?:1}" condition="is" value="MakerBot Innovation Center"]https://s3.amazonaws.com/cdn.terrapin.works/brand/terrapin-works-logo_final_red-black_MIC.png[/gravityforms]
                    '></img>
                
                [gravityforms action="conditional" merge_tag="{Which lab are you in?:1}" condition="is" value="MakerBot Innovation Center"]<img width="250px" src="https://s3.amazonaws.com/cdn.terrapin.works/brand/terrapin-works-logo_final_red-black_MIC.png"></img>[/gravityforms]
