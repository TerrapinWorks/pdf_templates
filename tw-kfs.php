...
<div class="row">
    <div class="col col-1-3">
        <div class="inner" height="40mm">
            <div><h3 class="section1_header">Billed To</h3></div><div class="bottompadding">{PI Name (First):59.3} {PI Name (Last):59.6}</div><h3 class="section1_header">Payment Method</h3><div>{How is the customer paying?:2} <span style="font-weight: 400">{KFS Account #:19}</span></div>
        </div>
    </div>
